INSERT INTO Projects
    (name, due_date)
VALUES
    ('Cookie Testing Project', '2018-04-20');
INSERT INTO Projects
    (name, due_date)
VALUES
    ('Motor Asembly Efficiency Analysis Project', '2018-04-26');
INSERT INTO Projects
    (name, due_date)
VALUES
    ('Project: Relax & Forget How to Code', '2018-05-21');

INSERT INTO Tasks
    (heading, description, due_date, project_id)
VALUES
    ('Connect some dots', 'Plenty of fleshed out details on the connecting of dots', '2018-04-20', 1);
INSERT INTO Tasks
    (heading, description, due_date, project_id)
VALUES
    ('Connect more dots', 'Plenty of fleshed out details on drawing lines between dots', '2018-04-22', 1);
INSERT INTO Tasks
    (heading, description, due_date, project_id)
VALUES
    ('QA: put a glove in a motor', 'Plenty of fleshed out details of the task', '2018-04-20', 2);
INSERT INTO Tasks
    (heading, description, due_date, project_id)
VALUES
    ('Line up all the parts', 'Plenty of fleshed out details of the task', '2018-04-20', 2);
INSERT INTO Tasks
    (heading, description, due_date, project_id)
VALUES
    ('Is the work never done..', 'Plenty of fleshed out details of the task', '2018-04-10', 3);

INSERT INTO Checklist_Items
    (text, task_id, due_date)
VALUES
    ('Check some boxes', 1);
INSERT INTO Checklist_Items
    (text, task_id, due_date)
VALUES
    ('Make things awesome', 2);
INSERT INTO Checklist_Items
    (text, task_id, due_date)
VALUES
    ('Check the rest of the boxes', 1);
INSERT INTO Checklist_Items
    (text, task_id, due_date)
VALUES
    ('Check some boxes', 4);
...
INSERT INTO Users
    (first_name, username)
VALUES
    ('Bill', 'and the Windsor is..');
INSERT INTO Users
    (first_name, username)
VALUES
    ('Ehler', 'supercoolusername777');
